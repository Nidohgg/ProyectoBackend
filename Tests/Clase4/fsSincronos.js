...
const rutaArchivo = path.resolve(__dirname, '../Clase4/archivo02.txt');
...
if(fs.existsSync(rutaArchivo)){
    let lecturaArchivo= fs.readFileSync(rutaArchivo, {encoding:"utf-8"})//read lee el archivo y con el consolelog lo imprime por consola
